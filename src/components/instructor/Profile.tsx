...
export default function InstructorProfilePage() {
    const { isOpen, openModal, closeModal, openPasswordModal, closePassModal, isOpenPassword } = useModal();
    ...
    const handlePasswordSave = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/v1/instructor/change-password`, {
                method: "POST",
                headers: {
    ...
    const fetchData = async () => {
        try {
            setLoading(true);
            const { token, IdToken, AccessToken } = getLoggedInUser();
            const response = await fetch(`${API_BASE_URL}/api/v1/instructor/get-profile`, {
                method: "GET",
                headers: {
                    Authorization: `Bearer ${token}`,
                    "X-ID-TOKEN": IdToken || "",
            ...
            const { instructor, instructorMetaData } = apidata.data;
            const formattedData = { instructor, instructorMetaData };
        ...
        <>
                ...
                <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
                    <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
                        <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
                            {data?.instructorMetaData?.profilePic != '' ?   (<Image
                                width={80}
                                height={80}
                                src={data?.instructorMetaData?.profilePic}
                                alt="user"
                                unoptimized
                            />) : (  <Image
                                width={80}
            ...
            <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
                <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                        ...
                        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                                    {data?.instructorMetaData?.organization ? data?.instructorMetaData?.organization : "Not Added"}
                                </p>
                            </div>
                            <div>
                                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                                    {data?.instructor?.phoneNumber ? data?.instructor?.phoneNumber : "Not Added"}
                                </p>
                            </div>
                            <div>
                                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">
                                ...
                                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                                    {data?.instructorMetaData?.bio ? data?.instructorMetaData?.bio : "Not Added"}
                                </p>
                            </div>
                            <div>
                                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">
                                ...
                                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                                    {data?.instructorMetaData?.jobTitle ? data?.instructorMetaData?.jobTitle : "Not Added"}
                                </p>
                            </div>
                            <div>
                                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">
                                ...
                                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                                    {data?.instructorMetaData?.expectedStudents ? data?.instructorMetaData?.expectedStudents : "Not Added"}
                                </p>
                            </div>
                            <div>
                                <p className="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">
                                ...
                                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                                    {data?.instructorMetaData?.topicTeach ? data?.instructorMetaData?.topicTeach : "Not Added"}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <Modal isOpen={isOpenPassword} onClose={closePassModal} className="max-w-[700px] m-4">
                        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
                            <div className="px-2 pr-14">
                                <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
                                    Change Password
                            ...
                            <form className="flex flex-col" onSubmit={handlePasswordSave}>
                                    ...
                                    <div className="mt-7">
                                        ...
                                        <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                                            <div className="col-span-2 lg:col-span-1">
                                                ...
                                                <Input type="password" name="oldPassword" onChange={handleChange} defaultValue="" />
                                                {errors?.oldPassword && (
                                            ...
                                            <div className="col-span-2 lg:col-span-1">
                                                ...
                                                <Input type="password" name="newPassword" onChange={handleChange} defaultValue="" />
                                                {errors?.newPassword && (
                                            ...
                                            <div className="col-span-2 lg:col-span-1">
                                                ...
                                                <Input type="password" name="confirmPassword" onChange={handleChange} defaultValue="" />
                                ...
                                <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
                                    <Button size="sm" variant="outline" onClick={closePassModal}>
                                        Close
                                    </Button>
                                    <Button disabled={mainloading} size="sm">
                                        Save Changes
                                    </Button>
                                </div>
                            </form>
